...
public class Case1 {
    ...
    public void второстепенный_банковский_код() {
    }

    @Тогда("Ввести {int}")
    public void ввести(Integer int1) {
    }

    @Дано("наименование банка")
    public void наименование_банка() {
    }

    @Тогда("Ввести любое текстовое значение латинскими буквами, длиной от {int} – {int} символов")
    public void ввести_любое_текстовое_значение_латинскими_буквами_длиной_от_символов(Integer int1, Integer int2) {
    }
    ...
    @Тогда("выбрать значение Активный")
    public void выбрать_значение_Активный() {
    }

    @Дано("Сдвиг даты платежа")
    public void сдвиг_даты_платежа() {
    }

    @Тогда("Ввест цифровое значение от {int}{int}")
    public void ввест_цифровое_значение_от(Integer int1, Integer int2) {
    }

    @Дано("Кнопка ОК")
    public void кнопка_ОК() {
    }
